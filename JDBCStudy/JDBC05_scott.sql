...
--○ 데이터 입력
INSERT INTO TBL_BUSEO(BUSEO_ID, BUSEO_NAME) VALUES(BUSEOSEQ.NEXTVAL, '개발부');    -- 1
INSERT INTO TBL_BUSEO(BUSEO_ID, BUSEO_NAME) VALUES(BUSEOSEQ.NEXTVAL, '기획부');    -- 2
INSERT INTO TBL_BUSEO(BUSEO_ID, BUSEO_NAME) VALUES(BUSEOSEQ.NEXTVAL, '영업부');    -- 3
INSERT INTO TBL_BUSEO(BUSEO_ID, BUSEO_NAME) VALUES(BUSEOSEQ.NEXTVAL, '인사부');    -- 4
INSERT INTO TBL_BUSEO(BUSEO_ID, BUSEO_NAME) VALUES(BUSEOSEQ.NEXTVAL, '자재부');    -- 5
INSERT INTO TBL_BUSEO(BUSEO_ID, BUSEO_NAME) VALUES(BUSEOSEQ.NEXTVAL, '총무부');    -- 6
INSERT INTO TBL_BUSEO(BUSEO_ID, BUSEO_NAME) VALUES(BUSEOSEQ.NEXTVAL, '홍보부');    -- 7
--==>> 1 행 이(가) 삽입되었습니다. * 7
...
VALUES (JIKWISEQ.NEXTVAL, '사장', 4250000);       -- 425만원    -- 1
INSERT INTO TBL_JIKWI(JIKWI_ID, JIKWI_NAME, MIN_BASICPAY)
VALUES (JIKWISEQ.NEXTVAL, '전무', 3800000);       -- 380만원    -- 2
INSERT INTO TBL_JIKWI(JIKWI_ID, JIKWI_NAME, MIN_BASICPAY)
VALUES (JIKWISEQ.NEXTVAL, '상무', 3500000);       -- 350만원    -- 3
INSERT INTO TBL_JIKWI(JIKWI_ID, JIKWI_NAME, MIN_BASICPAY)
VALUES (JIKWISEQ.NEXTVAL, '이사', 3100000);       -- 310만원    -- 4
INSERT INTO TBL_JIKWI(JIKWI_ID, JIKWI_NAME, MIN_BASICPAY)
VALUES (JIKWISEQ.NEXTVAL, '부장', 2450000);       -- 245만원    -- 5
INSERT INTO TBL_JIKWI(JIKWI_ID, JIKWI_NAME, MIN_BASICPAY)
VALUES (JIKWISEQ.NEXTVAL, '차장', 2350000);       -- 235만원    -- 6
INSERT INTO TBL_JIKWI(JIKWI_ID, JIKWI_NAME, MIN_BASICPAY)
VALUES (JIKWISEQ.NEXTVAL, '과장', 2260000);       -- 226만원    -- 7
INSERT INTO TBL_JIKWI(JIKWI_ID, JIKWI_NAME, MIN_BASICPAY)
VALUES (JIKWISEQ.NEXTVAL, '대리', 1250000);       -- 125만원    -- 8
INSERT INTO TBL_JIKWI(JIKWI_ID, JIKWI_NAME, MIN_BASICPAY)
VALUES (JIKWISEQ.NEXTVAL, '사원', 840000);        -- 84만원     -- 9
--==>> 1 행 이(가) 삽입되었습니다. * 9
...
-- 테이블 구조
-- TBL_CITY, TBL_BUSEO, TBL_JIKWI, TBL_EMP
DESC TBL_EMP;
DESC TBL_CITY;
DESC TBL_BUSEO;
DESC TBL_JIKWI;

-- EMP_ID, EMP_NAME, SSN, IBSADATE, CITY_LOC, TEL, BUSEO_NAME, JIKWI_NAME
-- , MIN_BASICPAY, BASICPAY, SUDANG, PAY(-> BASICPAY + SUDANG)

SELECT E.EMP_ID, E.EMP_NAME, E.SSN, E.IBSADATE, C.CITY_LOC, E.TEL, B.BUSEO_NAME
     , J.JIKWI_NAME, J.MIN_BASICPAY
     , E.BASICPAY, E.SUDANG
...
SELECT EMP_ID, EMP_NAME, SSN, IBSADATE, CITY_LOC, TEL, BUSEO_NAME, JIKWI_NAME
