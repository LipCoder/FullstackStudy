...
○ Vector(벡터)
  ...
  자바의 자료구조 기능을 제공하는 클래들 중 가장 기본적인 클래스로
  ...
  한쪽 끝에서만 접근이 가능한 스택과 다르게
  시쿼스 개념의 인덱스 값을 이용하여 자료 구조의 임의의 지점에서
  저장 및 접근이 가능하다.
  ...
  - int indexOf(Object o, int index)
    주어진 객체가 저장된 위치의 index 위치부터 찾아서 반환한다.
...
public class Test163
{
	...
	public static void main(String[] args)
	{
		...
		// 전체 요소 출력
		// [Iterator(이터레이션 or 아이터레이터)] 를 통해 전체 출력
