...
○ java.lang.Math 클래스는
   ...
   생성자가 있긴 하지만... 이 생성자는 *[private]* 으로 선언되어 있기 때문에
   외부에서 *객체(인스턴스)를 생성할 수 없다.*
   단, 모든 메소드가 [static]으로 정의되어 있으므로
   객체를 생성하지 않고 클래스의 이름을 통해 바로 접근하여 사용하는 것이 가능하다.
...
public class Test150
{
	public static void main(String[] args)
	{
		...
		//--==>> 0.0 ~ 1.0 사이의 난수 : 0.7274960492184198
		//		 0.0 ~ 1.0 사이의 난수 : 0.17674084930484701
		//		 0.0 ~ 1.0 사이의 난수 : 0.24213287545705742
		//		 0.0 ~ 1.0 사이의 난수 : 0.968625924281219
		//		 0.0 ~ 1.0 사이의 난수 : 0.6276754090084677
	}
}