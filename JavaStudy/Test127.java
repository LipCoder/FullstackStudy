...
○ 중첩 클래스(내부 클래스)
   ...
   만들 수 있는데 이러한 클래스를 중첩 클래스(내부 클래스)라 한다.
...
○ 중첩 클래스의 종류 (4가지)
   ...
   1. static 중첩 클래스(중첩 내부 클래스)
	  ...
	  내부 클래스를 감싸는 외부 클래스의 {} 안에
	  static을 붙은 새로운 클래스를 설계하는 것으로
