...
INSERT INTO REGION(REGIONID, REGIONNAME) VALUES(REGIONSEQ.NEXTVAL, NULL);
--==>> 1 행 이(가) 삽입되었습니다. * 16
...
-- 일반 직원이 조회하는 직원 전체 리스트 출력(추가) 쿼리문 구성
SELECT EMPLOYEEID, NAME, SSN, BIRTHDAY
     , LUNARNAME, TELEPHONE
...
--==>>
/*
2	권소윤	941007	1994-10-07	양력	010-5771-9551	개발부	사원	부산
3	김승범	921204	1992-12-05	음력	010-3441-0260	개발부	상무	서울
*/
