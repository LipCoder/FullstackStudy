...
VALUES(MEMBERLISTSEQ.NEXTVAL, '김종호', '010-1111-1111');
--> 한줄 구성
INSERT INTO TBL_MEMBERLIST(MID, NAME, TELEPHONE) VALUES(MEMBERLISTSEQ.NEXTVAL, '김종호', '010-1111-1111')
;
--==>> 1 행 이(가) 삽입되었습니다.

INSERT INTO TBL_MEMBERLIST(MID, NAME, TELEPHONE)
VALUES(MEMBERLISTSEQ.NEXTVAL, '정의진', '010-2222-2222');
--==>> 1 행 이(가) 삽입되었습니다.
