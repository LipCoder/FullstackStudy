...
<%
	...
	(RequestDispatcher가 없다면 심플한 MVC 디자인 패턴을 만들어 낼 수 없다.)
	
	※ 이 인터페이스는 『foward()』 와 『include()』 만 있다.
	
	※ 처리 과정 및 개념
	  
	   일반적으로 HttpServlet 을 상속 받는 클래스로 서블릿을 만들게 된다..
	   ...
	   『ServletContext』에서 할 수 있게 된다. (ex. 도서대출 관리 장부.., 작업반장 )
	   (※ 『ServletContext』
	   ...
	   『RequestDispatcher』 역시 그 기능 중의 하나이다.(ServletContext가 가지고있는..)
